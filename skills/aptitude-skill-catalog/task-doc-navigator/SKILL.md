...
description: "Use when locating the smallest relevant set of Aptitude docs, plans, tests, and code paths before implementation or review. Helps apply the appropriate Aptitude skill workflow."
metadata:
  version: "0.1.0"
  intent: "create_skill"
  tags: ["aptitude","documentation","navigation"]
  inputs_schema: {"type":"object","additionalProperties":true}
  outputs_schema: {"type":"object","additionalProperties":true}
  relationships: {"depends_on":[],"extends":[],"conflicts_with":[],"overlaps_with":[{"slug":"documentation-writer","version":"0.1.0"},{"slug":"writing-plans","version":"0.1.0"},{"slug":"architect-review","version":"0.1.0"}]}
---
# Task Doc Navigator
