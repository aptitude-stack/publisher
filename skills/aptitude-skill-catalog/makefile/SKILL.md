---
name: makefile
description: "Use when creating, reviewing, or debugging GNU Make targets, recipes, variables, functions, or build automation. Helps apply the appropriate Aptitude skill workflow."
metadata:
  version: "0.1.0"
  intent: "create_skill"
  ...
  relationships: {"depends_on":[],"extends":[],"conflicts_with":[],"overlaps_with":[{"slug":"uv","version":"0.1.0"},{"slug":"verification-before-completion","version":"0.1.0"}]}
---
# Makefile Skill
