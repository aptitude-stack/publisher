---
name: fastapi
description: "Use when building, reviewing, or refactoring FastAPI endpoints, Pydantic DTOs, dependency injection, routing, or API behavior. Helps apply the appropriate Aptitude skill workflow."
metadata:
  version: "0.1.0"
  intent: "create_skill"
  ...
  relationships: {"depends_on":[],"extends":[{"slug":"python-patterns","version":"0.1.0"}],"conflicts_with":[],"overlaps_with":[{"slug":"python-testing","version":"0.1.0"},{"slug":"ty","version":"0.1.0"}]}
---
# FastAPI
