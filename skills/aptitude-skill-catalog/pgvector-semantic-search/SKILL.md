...
description: "Use when implementing PostgreSQL vector search, pgvector indexes, embedding storage, semantic retrieval, or ANN tuning. Helps apply the appropriate Aptitude skill workflow."
metadata:
  version: "0.1.0"
  intent: "create_skill"
  tags: ["postgres","pgvector","semantic-search"]
  inputs_schema: {"type":"object","additionalProperties":true}
  outputs_schema: {"type":"object","additionalProperties":true}
  relationships: {"depends_on":[],"extends":[{"slug":"postgres-patterns","version":"0.1.0"}],"conflicts_with":[],"overlaps_with":[{"slug":"python-patterns","version":"0.1.0"}]}
---
