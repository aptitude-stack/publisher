...
description: "Use when evaluating architecture decisions, system design changes, scalability, resilience, maintainability, or domain boundaries. Helps apply the appropriate Aptitude skill workflow."
metadata:
  version: "0.1.0"
  intent: "create_skill"
  ...
  relationships: {"depends_on":[],"extends":[],"conflicts_with":[],"overlaps_with":[{"slug":"documentation-writer","version":"0.1.0"},{"slug":"requesting-code-review","version":"0.1.0"},{"slug":"task-doc-navigator","version":"0.1.0"}]}
---
