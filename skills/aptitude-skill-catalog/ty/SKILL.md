---
name: ty
description: "Use when type checking Python code, configuring ty, comparing type checker behavior, or fixing Python typing issues. Helps apply the appropriate Aptitude skill workflow."
metadata:
  version: "0.1.0"
  intent: "create_skill"
  tags: ["python","typing","type-checking"]
  inputs_schema: {"type":"object","additionalProperties":true}
  outputs_schema: {"type":"object","additionalProperties":true}
  relationships: {"depends_on":[],"extends":[{"slug":"python-patterns","version":"0.1.0"}],"conflicts_with":[],"overlaps_with":[{"slug":"uv","version":"0.1.0"},{"slug":"ruff","version":"0.1.0"}]}
---
# ty
