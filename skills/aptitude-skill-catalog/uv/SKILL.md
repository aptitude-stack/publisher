---
name: uv
description: "Use when managing Python projects, dependencies, virtual environments, scripts, locks, or tool execution with uv. Helps apply the appropriate Aptitude skill workflow."
metadata:
  version: "0.1.0"
  intent: "create_skill"
  ...
  relationships: {"depends_on":[],"extends":[],"conflicts_with":[],"overlaps_with":[{"slug":"python-patterns","version":"0.1.0"},{"slug":"ruff","version":"0.1.0"},{"slug":"ty","version":"0.1.0"}]}
---
# uv
