...
metadata:
  ...
  relationships: {"depends_on":[],"extends":[{"slug":"python-patterns","version":"0.1.0"}],"conflicts_with":[],"overlaps_with":[{"slug":"uv","version":"0.1.0"},{"slug":"verification-before-completion","version":"0.1.0"}]}
---
# ruff
