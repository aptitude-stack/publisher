---
name: ruff
description: "Use when linting, formatting, configuring, or fixing Python code with Ruff in a project that uses Ruff. Helps apply the appropriate Aptitude skill workflow."
metadata:
  version: "0.1.1"
  ...
  relationships: {"depends_on":[],"extends":[{"slug":"python-patterns","version":"0.1.1"}],"conflicts_with":[],"overlaps_with":[{"slug":"uv","version":"0.1.0"},{"slug":"verification-before-completion","version":"0.1.0"},{"slug":"python-testing","version":"0.1.1"}]}
---
# ruff
...
- Adds safer sequencing for lint fixes when tests are also being changed.
- Updates the Python patterns relationship to the staged `0.1.1` version.
- Adds an explicit rule to preview unsafe fixes before applying them.
...
### Coordinate lint fixes with test changes

When a task changes both implementation and tests, run Ruff after the focused tests fail or pass for the intended reason. This keeps mechanical lint cleanup from hiding whether the behavioral test was meaningful.
